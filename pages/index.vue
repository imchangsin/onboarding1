    ...
    <div id="login-box">
      <svg viewBox="0 0 791 143" class="icon">
        <g>
          ...
          <path d="M69.6951 75.3093L20.7067 39.7173L0.581543 54.339L28.7394 141H54.0425L72.5408 84.0679C73.5897 80.8401 72.4407 77.3042 69.6949 75.3092L69.6951 75.3093Z" fill="#65C6C6"></path>
...
export default {
  ...
  methods: {
    async login() {
      ...
      if(this.validationCheck(this.id, this.pw)) {
    ...
    validationCheck(id, pw){
      ...
      this.idError=!(regex.test(id)&&this.blackListCheck(id));
      this.pwError=pw==''?1:0;
      return !(this.idError||this.pwError);
    },
    blackListCheck(id){
      let blackList = ["test.com", "pooh.com"];
